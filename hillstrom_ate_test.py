...
def run_hillstrom_ate_test(args):
    ...
    bootstrap_rct = bootstrap(
        (ys,), np.mean, n_resamples=args.n_bootstrap, axis=0, random_state=args.seed
    )
    ...
    # ate_obs = estimate_ATE_HT(x_obs, t_obs, y_obs)
...
if __name__ == "__main__":
    ...
    run_hillstrom_ate_test(argmuments)
